...
1. Image preheating requires manual initiation by the customer and does not support automated preheating capabilities.
...
- he Ready status of the target image indicates whether the image for the target version has been successfully preheated.
```
corev1.PodCondition{
		Type:    PodImageReady,
		Status:  True,
