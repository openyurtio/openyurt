...
func Run(cfg *config.YurtHubConfiguration, stopCh <-chan struct{}) error {
	...
	klog.Infof("%d. new %s server and begin to serve, proxy server: %s, proxy secure server: %s, hub server: %s", trace, projectinfo.GetHubName(), cfg.YurtHubProxyServerAddr, cfg.YurtHubProxyServerSecureAddr, cfg.YurtHubServerAddr)
