...
*/}}
{{- define "yurt-controller-manager.chart" -}}
...
helm.sh/chart: {{ include "yurt-controller-manager.chart" . }}
...
*/}}
{{- define "yurt-controller-manager.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "yurt-controller-manager.fullname" .) .Values.serviceAccount.name }}
{{- else }}
