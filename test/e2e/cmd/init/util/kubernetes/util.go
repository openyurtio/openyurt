...
func DumpPod(client kubeclientset.Interface, pod *corev1.Pod, w io.Writer) error {
	...
	if err := kubectllogs.DefaultConsumeRequest(context.Background(), podRequest, w); err != nil {
	...
	if err := kubectllogs.DefaultConsumeRequest(context.Background(), req, w); err != nil {
