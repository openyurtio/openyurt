...
// IoTControllerConfiguration contains elements describing IoTController.
type IoTControllerConfiguration struct {
...
func NewIoTControllerConfiguration() *IoTControllerConfiguration {
	var (
		edgexconfig        = EdgeXConfig{}
		edgexnosectyconfig = EdgeXConfig{}
		conf               = IoTControllerConfiguration{
