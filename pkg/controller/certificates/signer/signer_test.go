...
func TestSigner(t *testing.T) {
	...
	s, err := newSigner(certmanager.YurtTunnelSignerName, "./testdata/ca.crt", "./testdata/ca.key", nil, 1*time.Hour)
	if err != nil {
...
func TestHandle(t *testing.T) {
	cases := []struct {
		...
		{
			name:       "should sign if signerName is yurt",
