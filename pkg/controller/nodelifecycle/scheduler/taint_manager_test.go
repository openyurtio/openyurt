...
/*
This file was derived from k8s.io/kubernetes/pkg/controller/nodelifecycle/scheduler/taint_manager_test.go
...
func TestUpdateNodeWithMultipleTaints(t *testing.T) {
	...
	// OpenYurt Authors:
	// In processPodOnNode of taint_manager.go, we will not cancel deletion
	// if it's already scheduled. So, do not run this case:
