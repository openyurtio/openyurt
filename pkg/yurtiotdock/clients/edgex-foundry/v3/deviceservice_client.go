...
func (eds *EdgexDeviceServiceClient) Create(ctx context.Context, deviceService *v1alpha1.DeviceService, options clients.CreateOptions) (*v1alpha1.DeviceService, error) {
...
func (eds *EdgexDeviceServiceClient) Convert(ctx context.Context, systemEvent dtos.SystemEvent, opts clients.GetOptions) (*v1alpha1.DeviceService, error) {
...
func (eds *EdgexDeviceServiceClient) Delete(ctx context.Context, name string, option clients.DeleteOptions) error {
...
func (eds *EdgexDeviceServiceClient) Update(ctx context.Context, ds *v1alpha1.DeviceService, options clients.UpdateOptions) (*v1alpha1.DeviceService, error) {
...
func (eds *EdgexDeviceServiceClient) Get(ctx context.Context, name string, options clients.GetOptions) (*v1alpha1.DeviceService, error) {
...
func (eds *EdgexDeviceServiceClient) List(ctx context.Context, options clients.ListOptions) ([]v1alpha1.DeviceService, error) {
