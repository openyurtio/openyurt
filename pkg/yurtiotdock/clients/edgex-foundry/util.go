...
func toKubeDeviceService(ds dtos.DeviceService) iotv1alpha1.DeviceService {
...
func toKubeDevice(ed dtos.Device) iotv1alpha1.Device {
	var loc string
	if ed.Location != nil {
...
func toKubeDeviceProfile(dp *dtos.DeviceProfile) iotv1alpha1.DeviceProfile {
