...
func (webhook *IoTHandler) SetupWebhookWithManager(mgr ctrl.Manager) (string, string, error) {
	...
	gvk, err := apiutil.GVKForObject(&v1alpha2.IoT{}, mgr.GetScheme())
	if err != nil {
		return "", "", err
	}
...
// +kubebuilder:webhook:path=/validate-device-openyurt-io-v1alpha2-iot,mutating=false,failurePolicy=fail,sideEffects=None,admissionReviewVersions=v1,groups=device.openyurt.io,resources=iots,verbs=create;update,versions=v1alpha2,name=viot.kb.io
// +kubebuilder:webhook:path=/mutate-device-openyurt-io-v1alpha2-iot,mutating=true,failurePolicy=fail,sideEffects=None,admissionReviewVersions=v1,groups=device.openyurt.io,resources=iots,verbs=create;update,versions=v1alpha2,name=miot.kb.io
