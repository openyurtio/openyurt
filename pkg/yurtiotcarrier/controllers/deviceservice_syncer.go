...
import (
	...
	iotcli "github.com/openyurtio/openyurt/pkg/yurtiotcarrier/clients"
...
func NewDeviceServiceSyncer(client client.Client, opts *options.YurtIotCarrierOptions) (DeviceServiceSyncer, error) {
