...
func (sp *multiplexerProxy) getReqScope(gvr *schema.GroupVersionResource, storage rest.Storage) (*handlers.RequestScope, error) {
	...
	if convertor, ok := storage.(rest.TableConvertor); ok {
		tableConvertor = convertor
	}
