...
import (
	...
	cdiscovery "k8s.io/client-go/discovery"
...
func TestShareCacheManager_ResourceCacheConfig(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		t.Run(tc.tname, func(t *testing.T) {
			...
			assert.Equal(t, tc.namespaceScoped, rc.NamespaceScoped)
		})
	}
}

func mockDiscoveryClient() cdiscovery.DiscoveryInterface {
...
func TestShareCacheManager_ResourceCache(t *testing.T) {
	...
	scm := NewShareCacheManager(dsm, mockDiscoveryClient())
