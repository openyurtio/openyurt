...
func NewStore(restClient rest.Interface, resource string) *store {
	return &store{
...
func (rs *store) Watch(ctx context.Context, key string, opts storage.ListOptions) (watch.Interface, error) {
...
func (rs *store) Versioner() storage.Versioner {
	return nil
}

func (rs *store) Create(ctx context.Context, key string, obj, out runtime.Object, ttl uint64) error {
	return ErrNoSupport
}

func (rs *store) Delete(
	ctx context.Context, key string, out runtime.Object, preconditions *storage.Preconditions,
	validateDeletion storage.ValidateObjectFunc, cachedExistingObject runtime.Object) error {
	return ErrNoSupport
}

func (rs *store) Get(ctx context.Context, key string, opts storage.GetOptions, objPtr runtime.Object) error {
	return ErrNoSupport
}

func (rs *store) GuaranteedUpdate(
	ctx context.Context, key string, destination runtime.Object, ignoreNotFound bool,
	preconditions *storage.Preconditions, tryUpdate storage.UpdateFunc, cachedExistingObject runtime.Object) error {
	return ErrNoSupport
}

func (rs *store) Count(key string) (int64, error) {
	return 0, ErrNoSupport
}

func (rs *store) RequestWatchProgress(ctx context.Context) error {
	return ErrNoSupport
}
