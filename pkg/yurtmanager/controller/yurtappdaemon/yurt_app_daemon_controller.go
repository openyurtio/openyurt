...
func (r *ReconcileYurtAppDaemon) updateStatus(instance *unitv1alpha1.YurtAppDaemon, newStatus, oldStatus *unitv1alpha1.YurtAppDaemonStatus,
	...
	newStatus = r.calculateStatus(newStatus, currentRevision, collisionCount, templateType)
...
func (r *ReconcileYurtAppDaemon) calculateStatus(newStatus *unitv1alpha1.YurtAppDaemonStatus,
